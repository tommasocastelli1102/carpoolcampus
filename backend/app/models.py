...
class Review(Base):
    ...
    stars_drive_safety: Mapped[int | None] = mapped_column(Integer, nullable=True)
    stars_clean_car: Mapped[int | None] = mapped_column(Integer, nullable=True)
    stars_punctuality: Mapped[int | None] = mapped_column(Integer, nullable=True)
    stars_good_company: Mapped[int | None] = mapped_column(Integer, nullable=True)
